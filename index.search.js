...
At the top, you have a table showing the top addresses you have sent funds to in the past 30 days, At the bottom, you have a chart showing the historical balance of your account (excluding transparent transactions) `,description:"",tags:null,title:"Budget",uri:"/market/budget/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:null,title:"Deposit",uri:"/maya/deposit/index.html"},{breadcrumb:"YWallet > Settings",content:` Display amounts in zats or millis. There are 100 000 000 zats per ZEC. Use Custom Send by default Reference Currency Default Memo Currency Use one of the supported FIAT currency or Crypto (BTC, ETH, etc.)
Custom Send Custom Send can be configured to show/hide the fields you want. See View.
`,description:"",tags:null,title:"General",uri:"/settings/general/index.html"},{breadcrumb:"YWallet",content:`Current version: 1.5.4 Platform Link Remarks Android Google Play Store Android APK No dependency on Google Apps iOS App Store Windows ZIP Portable, Just unzip and run Linux AppImage Need GLIB 2.34 Linux Flatpak Requires flatpack runtime Linux Flathub MacOS DMG For both Intel and Apple chips Source Code Github Info The Microsoft Store version is discontinued due to a change of their policy regarding self-custody crypto wallets.
`,description:"",tags:null,title:"Installation",uri:"/installation/index.html"},{breadcrumb:"YWallet > Recovery Tools",content:`The Key Derivation Tool allows you to determine the private keys and addresses at various standard paths.
...
`,description:"",tags:null,title:"New Account",uri:"/accounts/new/index.html"},{breadcrumb:"YWallet > Security",content:` With Protect Send active, making a payment will require device unlock On Mobile devices, you can also Protect Open. When turned on, launching the app required device unlock. On Desktop, Protect Open is replaced by the Database Encryption which will ask for the password at launch.
`,description:"",tags:null,title:"PIN/Fingerprint",uri:"/security/pin/index.html"},{breadcrumb:"YWallet > Transacting",content:`To receive funds, you can either give your wallet address or make a Payment URI.
...
In short,
if the sender has a wallet that supports Unified Addresses, use them. if it supports Sapling addresses (zs), use that instead. finally, if it only supports transparent addresses, use the t-addr. See Also Wallet Addresses `,description:"",tags:null,title:"Receive",uri:"/transacting/receive/index.html"},{breadcrumb:"YWallet > Synchronization",content:`Use Rescan when you want to reset all your accounts and scan the blockchain data from a given point in time / height.
...
`,description:"",tags:null,title:"Rescan",uri:"/sync/rescan/index.html"},{breadcrumb:"YWallet > Backup",content:`Saving the seed phrase is the #1 way to save your account. It is compatible with most wallet apps, i.e. you can recover your funds using another wallet than Ywallet.
...
`,description:"",tags:null,title:"Sync Status",uri:"/balance/sync_status/index.html"},{breadcrumb:"YWallet > History",content:`Any piece of information from that page can be copied to the clipboard.
...
`,description:"",tags:null,title:"Transaction Details",uri:"/history/details/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:null,title:"Withdraw",uri:"/maya/withdraw/index.html"},{breadcrumb:"YWallet > Account Info",content:`Unlike other cryptocurrencies, Zcash and Ycash accounts can have several addresses (with different properties).
...
`,description:"",tags:null,title:"Addresses",uri:"/balance/addresses/index.html"},{breadcrumb:"YWallet > Backup",content:`App Backup is a compressed & encrypted copy of the application database.
...
`,description:"",tags:null,title:"Database Encryption",uri:"/security/db/index.html"},{breadcrumb:"YWallet",content:` Press the “New Account” button to get started (whether it is your first time or you already have an old account you want to restore).
...
`,description:"",tags:null,title:"Getting Started",uri:"/getting_started/index.html"},{breadcrumb:"YWallet > Account Manager",content:`More/Notes
...
By Checkpoint `,description:"",tags:null,title:"Rewind",uri:"/sync/rewind/index.html"},{breadcrumb:"YWallet > Transacting",content:`To make a simple payment, you will need to know:
...
`,description:"",tags:null,title:"Send",uri:"/transacting/send/index.html"},{breadcrumb:"YWallet > Recovery Tools",content:`Sweep funds works with either
...
`,description:"",tags:null,title:"Sweep Funds",uri:"/tools/sweep/index.html"},{breadcrumb:"YWallet",content:`Balance
...
`,description:"",tags:null,title:"Account Info",uri:"/balance/index.html"},{breadcrumb:"YWallet > Account Info",content:` Balance in the currently selected address/pool Equivalent in fiat or Crypto reference currency , as selected in the settings, Funds available in the other pools The border is only shown when you have funds in the other pools and indicates that the balance displayed in the center is not your total balance.
Your total balance is affected by your note exclusion too.
`,description:"",tags:null,title:"Balance",uri:"/balance/balance/index.html"},{breadcrumb:"YWallet",content:`Unless an account is watch-only, it has the secret keys needed to perform transactions. Therefore it is important to keep your computer/phone away from intruders and malware.
...
`,description:"",tags:null,title:"Coin",uri:"/settings/coin/index.html"},{breadcrumb:"YWallet > Account Info",content:` A payment URI is a pre-filled payment slip. The sender can scan the QR code or input the payment URI in their wallet (if their wallet supports them) and the payment information is automatically filled.
...
`,description:"",tags:null,title:"Payment URI",uri:"/balance/payment_uri/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:null,title:"Swap To ZEC",uri:"/maya/swap_to/index.html"},{breadcrumb:"YWallet",content:`Besides checking your balance, making transactions is the bread and butter of any crypto wallet…
`,description:"",tags:null,title:"Transacting",uri:"/transacting/index.html"},{breadcrumb:"YWallet",content:`Contacts
...
`,description:"",tags:null,title:"Contacts",uri:"/contacts/index.html"},{breadcrumb:"YWallet > Settings",content:" Choose dark/light variant Predefined color schemes ",description:"",tags:null,title:"Theme",uri:"/settings/theme/index.html"},{breadcrumb:"YWallet",content:`History
...
`,description:"",tags:null,title:"History",uri:"/history/index.html"},{breadcrumb:"YWallet",content:`Messages
...
`,description:"",tags:null,title:"Messages",uri:"/messages/index.html"},{breadcrumb:"YWallet",content:`More/Pools
...
`,description:"",tags:null,title:"Pools",uri:"/pools/index.html"},{breadcrumb:"YWallet",content:`More/Synchronization
...
See Also
Rescan Rewind `,description:"",tags:null,title:"Synchronization",uri:"/sync/index.html"},{breadcrumb:"YWallet",content:`More/Accounts
...
`,description:"",tags:null,title:"Account Manager",uri:"/accounts/index.html"},{breadcrumb:"YWallet",content:`Maintaining a safe backup is extremely important.
...
`,description:"",tags:null,title:"Backup",uri:"/backup/index.html"},{breadcrumb:"YWallet",content:`See Cold Storage.
...
`,description:"",tags:null,title:"Cold Wallet",uri:"/coldwallet/index.html"},{breadcrumb:"YWallet",content:`In this section, you will find charts and tables related to your account transaction history and the value of the wallet.
Budget Market Prices `,description:"",tags:null,title:"Market Insights",uri:"/market/index.html"},{breadcrumb:"YWallet",content:`MultiPay allows you to create transactions with more than one recipient.
...
`,description:"",tags:null,title:"MultiPay",uri:"/multipay/index.html"},{breadcrumb:"YWallet",content:`The Recovery Tools help you import accounts from other wallet apps. They require some knowledge of the key derivation mechanism.
...
Transparent private keys. They begin with K or L. Use Sweep Funds Sapling private keys. They begin with secret-extended-key-main. Import the key as a new account. Then rescan as indicated `,description:"",tags:null,title:"Recovery Tools",uri:"/tools/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:null,title:"Settings",uri:"/settings/index.html"},{breadcrumb:"YWallet",content:`This document serves both as an introduction to the integration project of Zcash/ZEC into Maya Protocol (MP) and a technical feasibility study. In the first, we describe the architecture of MP and the workflows for deposit/withdraw and swap.
...
`,description:"",tags:null,title:"Maya Protocol / Zcash",uri:"/maya/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:null,title:"Categories",uri:"/categories/index.html"},{breadcrumb:"YWallet",content:"Save Copy the QR code to the clipboard Save the QR code as a PNG image file Scan ",description:"",tags:null,title:"QR",uri:"/qr/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:null,title:"Tags",uri:"/tags/index.html"},{breadcrumb:"",content:`YWallet is the most advanced and fastest Crypto Wallet for Zcash and Ycash.
Please use the Navigation Menu to read this documentation.
Don’t forget the SEARCH feature
`,description:"",tags:null,title:"YWallet",uri:"/index.html"}]