...
At the top, you have a table showing the top addresses you have sent funds to in the past 30 days, At the bottom, you have a chart showing the historical balance of your account (excluding transparent transactions) `,description:` The Budget Page has two parts.
At the top, you have a table showing the top addresses you have sent funds to in the past 30 days, At the bottom, you have a chart showing the historical balance of your account (excluding transparent transactions) `,tags:[],title:"Budget",uri:"/market/budget/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:[],title:"Deposit",uri:"/maya/deposit/index.html"},{breadcrumb:"YWallet > Settings",content:` Display amounts in zats or millis. There are 100 000 000 zats per ZEC. Use Custom Send by default Reference Currency Default Memo Currency Use one of the supported FIAT currency or Crypto (BTC, ETH, etc.)
Custom Send Custom Send can be configured to show/hide the fields you want. See View.`,description:`Display amounts in zats or millis. There are 100 000 000 zats per ZEC. Use Custom Send by default Reference Currency Default Memo Currency Use one of the supported FIAT currency or Crypto (BTC, ETH, etc.)
Custom Send Custom Send can be configured to show/hide the fields you want. See View.`,tags:[],title:"General",uri:"/settings/general/index.html"},{breadcrumb:"YWallet",content:"Current version: 1.5.4 Platform Link Remarks Android Google Play Store Android APK No dependency on Google Apps iOS App Store Windows ZIP Portable, Just unzip and run Linux AppImage Need GLIB 2.34 Linux Flatpak Requires flatpack runtime Linux Flathub MacOS DMG For both Intel and Apple chips Source Code Github Info The Microsoft Store version is discontinued due to a change of their policy regarding self-custody crypto wallets.",description:"Current version: 1.5.4 Platform Link Remarks Android Google Play Store Android APK No dependency on Google Apps iOS App Store Windows ZIP Portable, Just unzip and run Linux AppImage Need GLIB 2.34 Linux Flatpak Requires flatpack runtime Linux Flathub MacOS DMG For both Intel and Apple chips Source Code Github Info The Microsoft Store version is discontinued due to a change of their policy regarding self-custody crypto wallets.",tags:[],title:"Installation",uri:"/installation/index.html"},{breadcrumb:"YWallet > Recovery Tools",content:`The Key Derivation Tool allows you to determine the private keys and addresses at various standard paths.
...
The account index. ZWL increments it for every new shielded address Use External for receive addresses and Internal for change Address Index. ZWL increments it for every new transparent address. It is not used by shielded addresses Toggle between deriving shielded or transparent keys A list of 100 keys starting from the given account index. Add this address as a new account Note If you know which addresses have funds, just create new accounts for them.`,description:`The Key Derivation Tool allows you to determine the private keys and addresses at various standard paths.
Transparent and Shielded addresses use different derivation paths. Ywallet is programmed to follow the standards BIP-44 and ZIP-32.
The account index. ZWL increments it for every new shielded address Use External for receive addresses and Internal for change Address Index. ZWL increments it for every new transparent address. It is not used by shielded addresses Toggle between deriving shielded or transparent keys A list of 100 keys starting from the given account index.`,tags:[],title:"Key Derivation",uri:"/tools/key_derivation/index.html"},{breadcrumb:"YWallet > Messages",content:" Navigate to the previous/next message and to the previous/next message in the same thread. Threads are messages that share the same subject. Go to the transaction that contains the message. ",description:" Navigate to the previous/next message and to the previous/next message in the same thread. Threads are messages that share the same subject. Go to the transaction that contains the message. ",tags:[],title:"Message Details",uri:"/messages/details/index.html"},{breadcrumb:"YWallet > Account Manager",content:`New Enter the account name (required) Choose the crypto Press to create a new account The process should only take a few seconds.
...
Birth Height See Rescan.`,description:`New Enter the account name (required) Choose the crypto Press to create a new account The process should only take a few seconds.
Restore Turn on the restore switch Enter the wallet key Choose the account index. The account index is part of the derivation path. This is NOT the wallet birth height (see below). If you are unsure, leave it at 0 Press to restore the account The account is created but the blockchain data is not rescanned.`,tags:[],title:"New Account",uri:"/accounts/new/index.html"},{breadcrumb:"YWallet > Security",content:" With Protect Send active, making a payment will require device unlock On Mobile devices, you can also Protect Open. When turned on, launching the app required device unlock. On Desktop, Protect Open is replaced by the Database Encryption which will ask for the password at launch.",description:"With Protect Send active, making a payment will require device unlock On Mobile devices, you can also Protect Open. When turned on, launching the app required device unlock. On Desktop, Protect Open is replaced by the Database Encryption which will ask for the password at launch.",tags:[],title:"PIN/Fingerprint",uri:"/security/pin/index.html"},{breadcrumb:"YWallet > Transacting",content:`To receive funds, you can either give your wallet address or make a Payment URI.
...
In short,
if the sender has a wallet that supports Unified Addresses, use them. if it supports Sapling addresses (zs), use that instead. finally, if it only supports transparent addresses, use the t-addr. See Also Wallet Addresses `,description:`To receive funds, you can either give your wallet address or make a Payment URI.
With Zcash, the choice of the address is important because it determines where the funds will arrive.
Ywallet can show several types of addresses, as described in the address section.
In short,
if the sender has a wallet that supports Unified Addresses, use them. if it supports Sapling addresses (zs), use that instead. finally, if it only supports transparent addresses, use the t-addr.`,tags:[],title:"Receive",uri:"/transacting/receive/index.html"},{breadcrumb:"YWallet > Synchronization",content:`Use Rescan when you want to reset all your accounts and scan the blockchain data from a given point in time / height.
...
Warning From Jul 2023 to Oct 2024, the Zcash blockchain received an excessively high number of large transactions. If your wallet was created after that period, you should enter a birth height after Oct 2024. It will save you hours or even days.`,description:`Use Rescan when you want to reset all your accounts and scan the blockchain data from a given point in time / height.
This is particularly useful if you have an issue with your wallet and want to reset it, but also when you import an old account and want to recover its balance.
The synchronization data is deleted but your accounts are kept. Then the wallet starts downloading and scanning blocks from the given height.`,tags:[],title:"Rescan",uri:"/sync/rescan/index.html"},{breadcrumb:"YWallet > Backup",content:`Saving the seed phrase is the #1 way to save your account. It is compatible with most wallet apps, i.e. you can recover your funds using another wallet than Ywallet.
...
Seed phrase Other keys Export buttons Toggle the backup reminder from the main page `,description:`Saving the seed phrase is the #1 way to save your account. It is compatible with most wallet apps, i.e. you can recover your funds using another wallet than Ywallet.
However, every account has its own seed phrase and you MUST save every seed phrase if you have multiple accounts.
Moreover, the seed phrase saves your account keys but not the synchronizationd data. After you recover, you will have to rescan the blockchain from the account height.`,tags:[],title:"Seed & Keys",uri:"/backup/seed/index.html"},{breadcrumb:"YWallet > Account Info",content:`At regular intervals, the wallet will ‘ping’ the server and request the latest block data. When the wallet has up to date information, it will simply show the current block height.
...
This lets the user take manual action. They can resume the synchronization, choose to recover from a backup or rescan from a different height.`,description:`At regular intervals, the wallet will ‘ping’ the server and request the latest block data. When the wallet has up to date information, it will simply show the current block height.
But when it detects that it is behind, it will switch to “synchronization mode”.
Note Your transparent funds do not need full synchronization.
If you want to abort synchronization, simply close and rerun the app.
Synchronization Mode Synchronization mode is either “Rescan” or “Catchup”.`,tags:[],title:"Sync Status",uri:"/balance/sync_status/index.html"},{breadcrumb:"YWallet > History",content:`Any piece of information from that page can be copied to the clipboard.
Navigate to previous/next transaction Open the block explorer on the current transaction The block explorer can be selected in the settings.`,description:`Any piece of information from that page can be copied to the clipboard.
Navigate to previous/next transaction Open the block explorer on the current transaction The block explorer can be selected in the settings.`,tags:[],title:"Transaction Details",uri:"/history/details/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:[],title:"Withdraw",uri:"/maya/withdraw/index.html"},{breadcrumb:"YWallet > Account Info",content:`Unlike other cryptocurrencies, Zcash and Ycash accounts can have several addresses (with different properties).
...
Note Since diversified addresses only work with shielded receivers, the diversified addresses do not contain a transparent receiver even when the main address does.`,description:`Unlike other cryptocurrencies, Zcash and Ycash accounts can have several addresses (with different properties).
The Zcash protocol involves a few crypto systems and addresses:
the “traditional” Bitcoin inspired addresses: transparent addresses, the shielded/private addresses. Zcash has developed and improved shielded transactions based on zero-knowledge proofs. At this point, there are three types of private systems: Sprout, Sapling, Orchard. Note Zcash started with Sprout. Then Sapling drastically improved the performance. Finally Orchard eliminated the need for a trusted setup.`,tags:[],title:"Addresses",uri:"/balance/addresses/index.html"},{breadcrumb:"YWallet > Backup",content:`App Backup is a compressed & encrypted copy of the application database.
...
Decrypt the AGE file using age or rage unzip the result open the database files with SQL Lite 3+ `,description:`App Backup is a compressed & encrypted copy of the application database.
It contains all the account and the synchronization data.
By restoring from an app backup, you will only have to catchup from the point the backup was made.
This can be a huge time saver, especially if you have several accounts.
Generating a keypair The backup is encrypted using the AGE software suite. Before you can make a backup, you need to generate a keypair.`,tags:[],title:"App Backup",uri:"/backup/app/index.html"},{breadcrumb:"YWallet > Security",content:` Use this form to enter a new password or change the current one. To remove the password, enter a blank password as the new password.
The database files will remain encrypted on disk.
Warning If you forget your database password, you will not be able to open the app. You will need to delete the app data and recover from backup!`,description:`Use this form to enter a new password or change the current one. To remove the password, enter a blank password as the new password.
The database files will remain encrypted on disk.
Warning If you forget your database password, you will not be able to open the app. You will need to delete the app data and recover from backup!`,tags:[],title:"Database Encryption",uri:"/security/db/index.html"},{breadcrumb:"YWallet",content:` Press the “New Account” button to get started (whether it is your first time or you already have an old account you want to restore).
...
Next Steps New Account Security Select Server Themes Info For maximum privacy, consider running your own server. It is the only way to be 100% sure that the server operator does not collect tracking information.`,description:`Press the “New Account” button to get started (whether it is your first time or you already have an old account you want to restore).
Disclaimer Please read the disclaimer then check every box to enable the check mark button.
The app will move to the creation of the first account.
Next Steps New Account Security Select Server Themes Info For maximum privacy, consider running your own server. It is the only way to be 100% sure that the server operator does not collect tracking information.`,tags:[],title:"Getting Started",uri:"/getting_started/index.html"},{breadcrumb:"YWallet > Account Manager",content:`More/Notes
...
Height Amount / Pool. The color indicates the pool of the note Date/Time Invert the selection UTXO Like every coin based on the Bitcoin model, wallets in zcash are made of individual notes that are indivisible before spending.
...
By Checkpoint `,description:`Use Rewind when you want to rollback the synchronization data to a previous point and then make the wallet catch up from there.
Rewinding deletes the synchronization data after the given date/height.
This is useful if you notice an anomaly with your wallet that happened after a certain height. If you think your wallet was OK prior to that point, you can try rewinding to it and see if your issue is resolved.`,tags:[],title:"Rewind",uri:"/sync/rewind/index.html"},{breadcrumb:"YWallet > Transacting",content:`To make a simple payment, you will need to know:
...
You can set the type of address to include in the Settings.`,description:`To make a simple payment, you will need to know:
the recipient address, the amount. Press the send button at the bottom right corner of the account info page to open up the Send Form.
Addresses are practically never entered manually. They are either copy/pasted, scanned, or taken from the contact list.
The buttons (3) on the right side of the address will respectively:
open the QR scanner ask you to pick up a contact ask you to select one of the accounts (for account to account transfers) Note If the address is shielded, an encrypted memo can be added to the transaction.`,tags:[],title:"Send",uri:"/transacting/send/index.html"},{breadcrumb:"YWallet > Recovery Tools",content:`Sweep funds works with either
...
Your current account, into one the pools Or to any address (this appear when no pools are selected) You can only sweep transparent addresses and all the available funds are collected.`,description:`Sweep funds works with either
a seed phrase and will scan a range of addresses or a single transparent private key Then select the destination of the funds, Either
Your current account, into one the pools Or to any address (this appear when no pools are selected) You can only sweep transparent addresses and all the available funds are collected.`,tags:[],title:"Sweep Funds",uri:"/tools/sweep/index.html"},{breadcrumb:"YWallet",content:`Balance
This page shows information about your selected account. To switch between accounts, use the Account Manager
Synchronization Status Address(es) Balance Send Button The button/message “Backup Missing” is a reminder that you have not visited the Backup Page yet. Tap on it to go to Backup by Seed.`,description:`Balance
This page shows information about your selected account. To switch between accounts, use the Account Manager
Synchronization Status Address(es) Balance Send Button The button/message “Backup Missing” is a reminder that you have not visited the Backup Page yet. Tap on it to go to Backup by Seed.`,tags:[],title:"Account Info",uri:"/balance/index.html"},{breadcrumb:"YWallet > Account Info",content:` Balance in the currently selected address/pool Equivalent in fiat or Crypto reference currency , as selected in the settings, Funds available in the other pools The border is only shown when you have funds in the other pools and indicates that the balance displayed in the center is not your total balance.
Your total balance is affected by your note exclusion too.`,description:`Balance in the currently selected address/pool Equivalent in fiat or Crypto reference currency , as selected in the settings, Funds available in the other pools The border is only shown when you have funds in the other pools and indicates that the balance displayed in the center is not your total balance.
Your total balance is affected by your note exclusion too.`,tags:[],title:"Balance",uri:"/balance/balance/index.html"},{breadcrumb:"YWallet",content:`Unless an account is watch-only, it has the secret keys needed to perform transactions. Therefore it is important to keep your computer/phone away from intruders and malware.
...
You can set a minimum level of privacy. If a transaction cannot be made that matches or exceeds that level of privacy, you will have a warning message and the transaction will not be made unless you decide to override.`,description:`The Transaction Report gives you a summary of the transaction BEFORE it gets signed and broadcasted to the network.
Warning This is your final opportunity to check that everything is alright before the transaction becomes irreversible.
Output section. This shows every address you are sending funds to, by address and amount. If you are sending to a unified address, you can see what receiver was chosen. Summary of the source of funds by pool.`,tags:[],title:"Transaction Report",uri:"/transacting/report/index.html"},{breadcrumb:"YWallet > Settings",content:" Show Messages as a Table, a List or based on the device orientation Show Transaction History as a Table, a List or based on the device orientation Show Unspent Notes as a Table, a List or based on the device orientation Custom Send Open the field selection page for the Custom Send.",description:"Show Messages as a Table, a List or based on the device orientation Show Transaction History as a Table, a List or based on the device orientation Show Unspent Notes as a Table, a List or based on the device orientation Custom Send Open the field selection page for the Custom Send.",tags:[],title:"View",uri:"/settings/view/index.html"},{breadcrumb:"YWallet > Settings",content:` The Anti-Spam filter excludes the processing of large transactions that occurred during the spam period of 2023-2024. Calculate the fee automatically using ZIP-317 rules (highly recommended). You transaction may get stuck if the fees are too low Server Ping each server and get the latency URL of the block explorer Receivers included in the main address Receivers included in the reply-to address (used when you decide to include your address in a message) Receivers used when sending to a UA. See below Spam Filter Note To take full advantage of the spam filter, also connect to one of the Zcash Infra servers
...
Receivers For example if you only select Orchard and send to a UA that has Transparent, Sapling & Orchard receivers, only the Orchard receiver will be used`,description:"The Anti-Spam filter excludes the processing of large transactions that occurred during the spam period of 2023-2024. Calculate the fee automatically using ZIP-317 rules (highly recommended). You transaction may get stuck if the fees are too low Server Ping each server and get the latency URL of the block explorer Receivers included in the main address Receivers included in the reply-to address (used when you decide to include your address in a message) Receivers used when sending to a UA.",tags:[],title:"Coin",uri:"/settings/coin/index.html"},{breadcrumb:"YWallet > Account Info",content:` A payment URI is a pre-filled payment slip. The sender can scan the QR code or input the payment URI in their wallet (if their wallet supports them) and the payment information is automatically filled.
...
Note Payment URIs are similar to invoices.`,description:`A payment URI is a pre-filled payment slip. The sender can scan the QR code or input the payment URI in their wallet (if their wallet supports them) and the payment information is automatically filled.
To create a payment URI, enter:
the address. You can swipe through the different types of address the amount in ZEC or the amount in the reference currency. It will be converted to ZEC automatically A memo.`,tags:[],title:"Payment URI",uri:"/balance/payment_uri/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:[],title:"Swap To ZEC",uri:"/maya/swap_to/index.html"},{breadcrumb:"YWallet",content:"Besides checking your balance, making transactions is the bread and butter of any crypto wallet…",description:"Besides checking your balance, making transactions is the bread and butter of any crypto wallet…",tags:[],title:"Transacting",uri:"/transacting/index.html"},{breadcrumb:"YWallet",content:`Contacts
...
If you store a unified address, the wallet will recognize a transaction made to any of its receivers.`,description:`Contacts
Contacts is an address book that stores names and addresses.
Note Each account has its own address book but the Contacts page combines all the contacts.
When you create a new contact, it is saved in the current account.
List of contacts Button for adding a new contact Button to save contacts to the blockchain Saving your contacts to the blockchain makes a special self-transaction that contains your unsaved contacts.`,tags:[],title:"Contacts",uri:"/contacts/index.html"},{breadcrumb:"YWallet > Settings",content:" Choose dark/light variant Predefined color schemes ",description:" Choose dark/light variant Predefined color schemes ",tags:[],title:"Theme",uri:"/settings/theme/index.html"},{breadcrumb:"YWallet",content:`History
...
Ywallet retrieves the transparent balance using a separate API call that does not require synchronization.`,description:`History
This is your transaction history.
It can be displayed in table or list layout.
List Table The table format shows more information and is better suited for larger screen.
You can also sort the columns by clicking on the column headers.
The layout can be selected in the settings
Clicking or tapping on a transaction will navigate to the transaction details.
Warning Transactions that do not involve any shielded input/output, i.`,tags:[],title:"History",uri:"/history/index.html"},{breadcrumb:"YWallet",content:`Messages
...
Clicking or tapping on a message will navigate to the corresponding transaction.`,description:`Messages
With transactions, you can have memos or messages.
Messages are your transaction memos shown in a more friendly way. Like transactions, they can be organized as a list or as a table.
List Table If you have a contact in your address book with the matching address, Ywallet will display the contact name instead of the address.
Also, the list shows your message as a chat. However, some of the messages may not have a known sender.`,tags:[],title:"Messages",uri:"/messages/index.html"},{breadcrumb:"YWallet",content:`More/Pools
...
See Also
Rescan Rewind `,description:`More/Synchronization
After installation, the wallet starts with no data from the blockchain/network.
Synchronization is the process by which the wallet gets the transaction data and updates its database.
There are two types of information:
accounts and keys: only you should know that. synchronization data: derived from the keys and the blockchain data. Light wallets The blockchain has hundreds of GB of data. It contains all the transactions of every user. Therefore it will keep growing larger and larger.`,tags:[],title:"Synchronization",uri:"/sync/index.html"},{breadcrumb:"YWallet",content:`More/Accounts
...
At the moment, there is no way to reorder accounts.`,description:`More/Accounts
The Account Manager is where you add/edit/delete accounts.
Switch Account To change the current account, tap on its name.
New See new account
Edit/Delete Long press on an account name to enter edit mode. Then you will have the option to rename or delete it.
Note The current account cannot be deleted unless it is the only account remaining. You need to switch to another account.
At the moment, there is no way to reorder accounts.`,tags:[],title:"Account Manager",uri:"/accounts/index.html"},{breadcrumb:"YWallet",content:`Maintaining a safe backup is extremely important.
...
By seed phrase or secret key By saving an encrypted copy of its database Each has its own benefits and drawbacks. But you should at least have one type of backup.`,description:`Maintaining a safe backup is extremely important.
Warning Without a backup, your funds are irremediably LOST in case of a hardware or software failure.
Ywallet supports two types of backups:
By seed phrase or secret key By saving an encrypted copy of its database Each has its own benefits and drawbacks. But you should at least have one type of backup.`,tags:[],title:"Backup",uri:"/backup/index.html"},{breadcrumb:"YWallet",content:`See Cold Storage.
...
Congratulations, you have made a cold wallet transaction.`,description:`See Cold Storage.
The Cold Wallet feature uses two devices running Ywallet.
the first device has the viewing key and is connected to the Internet. It can synchronize and report the account balance, but it cannot spend the second device has the secret key but is disconnected from the Internet. It can sign transactions prepared on the first device By keeping the secret key on a device that remains offline permanently, the account cannot be hacked by remote access.`,tags:[],title:"Cold Wallet",uri:"/coldwallet/index.html"},{breadcrumb:"YWallet",content:`In this section, you will find charts and tables related to your account transaction history and the value of the wallet.
Budget Market Prices `,description:`In this section, you will find charts and tables related to your account transaction history and the value of the wallet.
Budget Market Prices `,tags:[],title:"Market Insights",uri:"/market/index.html"},{breadcrumb:"YWallet",content:`MultiPay allows you to create transactions with more than one recipient.
...
Note When using MultiPay, it is not possible to restrict the source of the funds to a given set of pools.`,description:`MultiPay allows you to create transactions with more than one recipient.
To use it, start by opening the MultiPay Page. Then,
Add Recipients, this will open the Send Page or the Custom Send Page The current recipients will appear here. If you need to delete an item, long press on it then press the delete button Finish up by pressing the send button. You’ll navigate to the Transaction Report as usual.`,tags:[],title:"MultiPay",uri:"/multipay/index.html"},{breadcrumb:"YWallet",content:`The Recovery Tools help you import accounts from other wallet apps. They require some knowledge of the key derivation mechanism.
...
Transparent private keys. They begin with K or L. Use Sweep Funds Sapling private keys. They begin with secret-extended-key-main. Import the key as a new account. Then rescan as indicated `,description:`The Recovery Tools help you import accounts from other wallet apps. They require some knowledge of the key derivation mechanism.
Here is a brief recap on the topic.
Transparent Wallet Let’s consider a typical Zcash transparent wallet. It supports multiple currencies, all under the same seed phrase.
Derivation Path From a given seed phrase, you can derive lots of keys using a set of rules and a “path”.
A path looks like a directory path except that each component is an integer.`,tags:[],title:"Recovery Tools",uri:"/tools/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:[],title:"Settings",uri:"/settings/index.html"},{breadcrumb:"YWallet",content:`YWallet went through two security reviews conducted by
Taylor Hornby (former ECC employee and Zcash Protocol Engineer); Least Authority. Both following grants from the Zcash Community Grants
Reports The reports are available for download:
Ywallet Security and Privacy Analysis ZCG Consultation Feedback Disclosure If you find a security issue, please report it to the author via email to Ywallet Email
For encrypted communication, use the following AGE public key age1ys5w8jljape5nr40n4gg2zfh6a5tf4eq6xfsftlw8dmnnfeczd3q2pqgnd`,description:`YWallet went through two security reviews conducted by
Taylor Hornby (former ECC employee and Zcash Protocol Engineer); Least Authority. Both following grants from the Zcash Community Grants
Reports The reports are available for download:
Ywallet Security and Privacy Analysis ZCG Consultation Feedback Disclosure If you find a security issue, please report it to the author via email to Ywallet Email
For encrypted communication, use the following AGE public key age1ys5w8jljape5nr40n4gg2zfh6a5tf4eq6xfsftlw8dmnnfeczd3q2pqgnd`,tags:[],title:"Security & Audit",uri:"/audit/index.html"},{breadcrumb:"YWallet",content:`This document serves both as an introduction to the integration project of Zcash/ZEC into Maya Protocol (MP) and a technical feasibility study. In the first, we describe the architecture of MP and the workflows for deposit/withdraw and swap.
...
The difference is the addition of the zcash-client but that could be made part of the zcash docker image.`,description:`This document serves both as an introduction to the integration project of Zcash/ZEC into Maya Protocol (MP) and a technical feasibility study. In the first, we describe the architecture of MP and the workflows for deposit/withdraw and swap.
Next, we’ll discuss how to add ZEC as a new chain which will allow the creation of the liquidity pool ZEC.
We aim to have transparent & shielded ZEC available both as a source and a destination of a swap.`,tags:[],title:"Maya Protocol / Zcash",uri:"/maya/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:[],title:"Categories",uri:"/categories/index.html"},{breadcrumb:"YWallet",content:"Save Copy the QR code to the clipboard Save the QR code as a PNG image file Scan ",description:"Save Copy the QR code to the clipboard Save the QR code as a PNG image file Scan ",tags:[],title:"QR",uri:"/qr/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:[],title:"Tags",uri:"/tags/index.html"},{breadcrumb:"",content:`YWallet is the most advanced and fastest Crypto Wallet for Zcash and Ycash.
Please use the Navigation Menu to read this documentation.
Don’t forget the SEARCH feature`,description:`YWallet is the most advanced and fastest Crypto Wallet for Zcash and Ycash.
Please use the Navigation Menu to read this documentation.
Don’t forget the SEARCH feature`,tags:[],title:"YWallet",uri:"/index.html"}]