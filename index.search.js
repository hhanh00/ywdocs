...
At the top, you have a table showing the top addresses you have sent funds to in the past 30 days, At the bottom, you have a chart showing the historical balance of your account (excluding transparent transactions) `,tags:[],title:"Budget",uri:"/ywdocs/market/budget/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:[],title:"Deposit",uri:"/ywdocs/maya/deposit/index.html"},{breadcrumb:"YWallet > Settings",content:` Display amounts in zats or millis. There are 100 000 000 zats per ZEC. Use Custom Send by default Reference Currency Default Memo Currency Use one of the supported FIAT currency or Crypto (BTC, ETH, etc.)
...
Restore Turn on the restore switch Enter the wallet key Choose the account index. The account index is part of the derivation path. This is NOT the wallet birth height (see below). If you are unsure, leave it at 0 Press to restore the account The account is created but the blockchain data is not rescanned.`,tags:[],title:"New Account",uri:"/ywdocs/accounts/new/index.html"},{breadcrumb:"YWallet > Security",content:" With Protect Send active, making a payment will require device unlock On Mobile devices, you can also Protect Open. When turned on, launching the app required device unlock. On Desktop, Protect Open is replaced by the Database Encryption which will ask for the password at launch.",description:"With Protect Send active, making a payment will require device unlock On Mobile devices, you can also Protect Open. When turned on, launching the app required device unlock. On Desktop, Protect Open is replaced by the Database Encryption which will ask for the password at launch.",tags:[],title:"PIN/Fingerprint",uri:"/ywdocs/security/pin/index.html"},{breadcrumb:"YWallet > Transacting",content:`To receive funds, you can either give your wallet address or make a Payment URI.
...
Ywallet can show several types of addresses, as described in the address section.
In short,
if the sender has a wallet that supports Unified Addresses, use them. if it supports Sapling addresses (zs), use that instead. finally, if it only supports transparent addresses, use the t-addr.`,tags:[],title:"Receive",uri:"/ywdocs/transacting/receive/index.html"},{breadcrumb:"YWallet > Synchronization",content:`Use Rescan when you want to reset all your accounts and scan the blockchain data from a given point in time / height.
...
This is particularly useful if you have an issue with your wallet and want to reset it, but also when you import an old account and want to recover its balance.
The synchronization data is deleted but your accounts are kept. Then the wallet starts downloading and scanning blocks from the given height.`,tags:[],title:"Rescan",uri:"/ywdocs/sync/rescan/index.html"},{breadcrumb:"YWallet > Backup",content:`Saving the seed phrase is the #1 way to save your account. It is compatible with most wallet apps, i.e. you can recover your funds using another wallet than Ywallet.
...
Note Your transparent funds do not need full synchronization.
If you want to abort synchronization, simply close and rerun the app.
Synchronization Mode Synchronization mode is either “Rescan” or “Catchup”.`,tags:[],title:"Sync Status",uri:"/ywdocs/balance/sync_status/index.html"},{breadcrumb:"YWallet > History",content:`Any piece of information from that page can be copied to the clipboard.
...
Navigate to previous/next transaction Open the block explorer on the current transaction The block explorer can be selected in the settings.`,tags:[],title:"Transaction Details",uri:"/ywdocs/history/details/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:[],title:"Withdraw",uri:"/ywdocs/maya/withdraw/index.html"},{breadcrumb:"YWallet > Account Info",content:`Unlike other cryptocurrencies, Zcash and Ycash accounts can have several addresses (with different properties).
...
The Zcash protocol involves a few crypto systems and addresses:
the “traditional” Bitcoin inspired addresses: transparent addresses, the shielded/private addresses. Zcash has developed and improved shielded transactions based on zero-knowledge proofs. At this point, there are three types of private systems: Sprout, Sapling, Orchard. Note Zcash started with Sprout. Then Sapling drastically improved the performance. Finally Orchard eliminated the need for a trusted setup.`,tags:[],title:"Addresses",uri:"/ywdocs/balance/addresses/index.html"},{breadcrumb:"YWallet > Backup",content:`App Backup is a compressed & encrypted copy of the application database.
...
By restoring from an app backup, you will only have to catchup from the point the backup was made.
This can be a huge time saver, especially if you have several accounts.
Generating a keypair The backup is encrypted using the AGE software suite. Before you can make a backup, you need to generate a keypair.`,tags:[],title:"App Backup",uri:"/ywdocs/backup/app/index.html"},{breadcrumb:"YWallet > Security",content:` Use this form to enter a new password or change the current one. To remove the password, enter a blank password as the new password.
...
The database files will remain encrypted on disk.
Warning If you forget your database password, you will not be able to open the app. You will need to delete the app data and recover from backup!`,tags:[],title:"Database Encryption",uri:"/ywdocs/security/db/index.html"},{breadcrumb:"YWallet",content:` Press the “New Account” button to get started (whether it is your first time or you already have an old account you want to restore).
...
Rewinding deletes the synchronization data after the given date/height.
This is useful if you notice an anomaly with your wallet that happened after a certain height. If you think your wallet was OK prior to that point, you can try rewinding to it and see if your issue is resolved.`,tags:[],title:"Rewind",uri:"/ywdocs/sync/rewind/index.html"},{breadcrumb:"YWallet > Transacting",content:`To make a simple payment, you will need to know:
...
a seed phrase and will scan a range of addresses or a single transparent private key Then select the destination of the funds, Either
Your current account, into one the pools Or to any address (this appear when no pools are selected) You can only sweep transparent addresses and all the available funds are collected.`,tags:[],title:"Sweep Funds",uri:"/ywdocs/tools/sweep/index.html"},{breadcrumb:"YWallet",content:`Balance
...
YWallet has several security features that help you prevent loss of funds but be aware that when your device is connected to the Internet there is a level of risk that cannot be avoided.
See Cold Wallet for a way to make transaction while keeping your secret keys on a disconnected device.`,tags:[],title:"Security",uri:"/ywdocs/security/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:[],title:"Swap From ZEC",uri:"/ywdocs/maya/swap_from/index.html"},{breadcrumb:"YWallet > Transacting",content:`The Transaction Report gives you a summary of the transaction BEFORE it gets signed and broadcasted to the network.
...
To create a payment URI, enter:
the address. You can swipe through the different types of address the amount in ZEC or the amount in the reference currency. It will be converted to ZEC automatically A memo.`,tags:[],title:"Payment URI",uri:"/ywdocs/balance/payment_uri/index.html"},{breadcrumb:"YWallet > Maya Protocol / Zcash",content:"",description:"",tags:[],title:"Swap To ZEC",uri:"/ywdocs/maya/swap_to/index.html"},{breadcrumb:"YWallet",content:"Besides checking your balance, making transactions is the bread and butter of any crypto wallet…",description:"Besides checking your balance, making transactions is the bread and butter of any crypto wallet…",tags:[],title:"Transacting",uri:"/ywdocs/transacting/index.html"},{breadcrumb:"YWallet",content:`Contacts
...
Note Each account has its own address book but the Contacts page combines all the contacts.
When you create a new contact, it is saved in the current account.
List of contacts Button for adding a new contact Button to save contacts to the blockchain Saving your contacts to the blockchain makes a special self-transaction that contains your unsaved contacts.`,tags:[],title:"Contacts",uri:"/ywdocs/contacts/index.html"},{breadcrumb:"YWallet > Settings",content:" Choose dark/light variant Predefined color schemes ",description:" Choose dark/light variant Predefined color schemes ",tags:[],title:"Theme",uri:"/ywdocs/settings/theme/index.html"},{breadcrumb:"YWallet",content:`History
...
The layout can be selected in the settings
Clicking or tapping on a transaction will navigate to the transaction details.
Warning Transactions that do not involve any shielded input/output, i.`,tags:[],title:"History",uri:"/ywdocs/history/index.html"},{breadcrumb:"YWallet",content:`Messages
...
Messages are your transaction memos shown in a more friendly way. Like transactions, they can be organized as a list or as a table.
List Table If you have a contact in your address book with the matching address, Ywallet will display the contact name instead of the address.
Also, the list shows your message as a chat. However, some of the messages may not have a known sender.`,tags:[],title:"Messages",uri:"/ywdocs/messages/index.html"},{breadcrumb:"YWallet",content:`More/Pools
...
transparent sapling orchard The last two are shielded.
Funds from any pool are fungible. In other words, you can make a transaction that uses funds from any pool, and pays to any pool. There is no financial difference between them, like there is no difference between the 1 USD note and the 1 USD coin.
However, it does not mean that they have the same properties.`,tags:[],title:"Pools",uri:"/ywdocs/pools/index.html"},{breadcrumb:"YWallet",content:`More/Synchronization
...
Edit/Delete Long press on an account name to enter edit mode. Then you will have the option to rename or delete it.
Note The current account cannot be deleted unless it is the only account remaining. You need to switch to another account.
At the moment, there is no way to reorder accounts.`,tags:[],title:"Account Manager",uri:"/ywdocs/accounts/index.html"},{breadcrumb:"YWallet",content:`Maintaining a safe backup is extremely important.
...
Warning Without a backup, your funds are irremediably LOST in case of a hardware or software failure.
Ywallet supports two types of backups:
By seed phrase or secret key By saving an encrypted copy of its database Each has its own benefits and drawbacks. But you should at least have one type of backup.`,tags:[],title:"Backup",uri:"/ywdocs/backup/index.html"},{breadcrumb:"YWallet",content:`See Cold Storage.
...
The Cold Wallet feature uses two devices running Ywallet.
the first device has the viewing key and is connected to the Internet. It can synchronize and report the account balance, but it cannot spend the second device has the secret key but is disconnected from the Internet. It can sign transactions prepared on the first device By keeping the secret key on a device that remains offline permanently, the account cannot be hacked by remote access.`,tags:[],title:"Cold Wallet",uri:"/ywdocs/coldwallet/index.html"},{breadcrumb:"YWallet",content:`In this section, you will find charts and tables related to your account transaction history and the value of the wallet.
...
Budget Market Prices `,tags:[],title:"Market Insights",uri:"/ywdocs/market/index.html"},{breadcrumb:"YWallet",content:`MultiPay allows you to create transactions with more than one recipient.
...
Transparent Wallet Let’s consider a typical Zcash transparent wallet. It supports multiple currencies, all under the same seed phrase.
Derivation Path From a given seed phrase, you can derive lots of keys using a set of rules and a “path”.
A path looks like a directory path except that each component is an integer.`,tags:[],title:"Recovery Tools",uri:"/ywdocs/tools/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:[],title:"Settings",uri:"/ywdocs/settings/index.html"},{breadcrumb:"YWallet",content:`YWallet went through two security reviews conducted by
...
Reports The reports are available for download:
Ywallet Security and Privacy Analysis ZCG Consultation Feedback Disclosure If you find a security issue, please report it to the author via email to Ywallet Email
For encrypted communication, use the following AGE public key age1ys5w8jljape5nr40n4gg2zfh6a5tf4eq6xfsftlw8dmnnfeczd3q2pqgnd`,tags:[],title:"Security & Audit",uri:"/ywdocs/audit/index.html"},{breadcrumb:"YWallet",content:`This document serves both as an introduction to the integration project of Zcash/ZEC into Maya Protocol (MP) and a technical feasibility study. In the first, we describe the architecture of MP and the workflows for deposit/withdraw and swap.
...
Next, we’ll discuss how to add ZEC as a new chain which will allow the creation of the liquidity pool ZEC.
We aim to have transparent & shielded ZEC available both as a source and a destination of a swap.`,tags:[],title:"Maya Protocol / Zcash",uri:"/ywdocs/maya/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:[],title:"Categories",uri:"/ywdocs/categories/index.html"},{breadcrumb:"YWallet",content:"Save Copy the QR code to the clipboard Save the QR code as a PNG image file Scan ",description:"Save Copy the QR code to the clipboard Save the QR code as a PNG image file Scan ",tags:[],title:"QR",uri:"/ywdocs/qr/index.html"},{breadcrumb:"YWallet",content:"",description:"",tags:[],title:"Tags",uri:"/ywdocs/tags/index.html"},{breadcrumb:"",content:`YWallet is the most advanced and fastest Crypto Wallet for Zcash and Ycash.
...
Please use the Navigation Menu to read this documentation.
Don’t forget the SEARCH feature`,tags:[],title:"YWallet",uri:"/ywdocs/index.html"}]